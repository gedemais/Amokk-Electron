  ...
  const plans = [
    {
      ...
      features: [
        ...
        t("components.dashboard.PricingDialog.starter_features2"),
      ],
      planId: 3,
    },
    {
      ...
      features: [
        ...
        t("components.dashboard.PricingDialog.tryhard_features2"),
      ],
      planId: 4,
    },
    {
      ...
      features: [
        ...
        t("components.dashboard.PricingDialog.rush_features2"),
      ],
      planId: 5,
    },
  ];
